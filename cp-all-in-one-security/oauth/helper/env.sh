# IDP configurations
export IDP_TOKEN_ENDPOINT=http://keycloak:8080/realms/cp/protocol/openid-connect/auth
export IDP_JWKS_ENDPOINT=http://keycloak:8080/realms/cp/protocol/openid-connect/keys
...
export RP_CLIENT_SECRET=rp_client_app
...
export SSO_SUPER_USER_GROUP=g12
