...
5. Configure Schema Registry, Connect, KSQL and Control Center to authenticate via OAuth.
6. Datagen source connector plugin is added in Connect.
7. Configure Control Center to talk to MDS, Schema Registry, KSQL and Connect.
...
```
{"KsqlServerInfo":{"version":"7.8.0","kafkaClusterId":"vHCgQyIrRHG8Jv27qI2h3Q","ksqlServiceId":"ksql-cluster","serverStatus":"RUNNING"}}%
```
